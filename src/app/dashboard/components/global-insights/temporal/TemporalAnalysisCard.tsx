...
export default function TemporalAnalysisCard({
  ...
  // Get relative time string from days
            ...
            <div className="space-y-2 p-4 rounded-lg bg-orange-50 border border-orange-200">
              ...
              <div className="flex items-baseline gap-2">
                <span className={`text-2xl font-bold ${daysStatus.color}`}>
                  {temporal.daysSinceLastCollection ?? "N/A"}
                </span>
                {temporal.daysSinceLastCollection !== null && (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-yellow-700">
                      Last collection was {temporal.daysSinceLastCollection}{" "}
                      days ago. Consider triggering a manual collection to
