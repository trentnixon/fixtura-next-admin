...
- `page.tsx`: Entry point for the fixture detail page (`useSingleFixtureDetail`, actions bar, match summary, validation)
...
- `_components/`: Fixture detail UI components (`FixtureActionsBar`, `FixtureMatch`, `TriggerResultSingleScrapeButton`, validation, etc.)

## Relations

- Parent folder: [../readMe.md](../readMe.md)
- Key dependencies: `../../../components/` scaffolding + UI primitives, `../../../../hooks/fixtures/` for data hooks, `../../../../lib/services/fixtures/` + `../../../../lib/services/data-collection/` for CMS calls, `../../../../types/` for shared contracts
- Consumed by: Dashboard router at `/dashboard/fixtures/[id]`

## Dependencies

- Internal:
  - `../../../../hooks/fixtures/useSingleFixtureDetail.ts`: React Query hook for single fixture detail
  - `../../../../hooks/fixtures/useTriggerResultSingleScrape.ts`: Mutation hook for CMS result-single scrape trigger
  - `../../../../lib/services/fixtures/fetchSingleFixtureDetail.ts`: CMS GET wrapper for `/game-meta-data/admin/fixture/{id}`
  - `../../../../lib/services/data-collection/triggerResultSingleScrape.ts`: Server action POST trigger-result-single-scrape
  - `../../../../types/fixtureDetail.ts`: TypeScript interfaces for single fixture detail response
  - `../../../../types/triggerResultSingleScrape.ts`: Types for result-single scrape trigger request/response
...
- **Detail route**: `GET /api/game-meta-data/admin/fixture/{id}`
- **Result scrape trigger**: `POST /api/game-meta-data/trigger-result-single-scrape`
