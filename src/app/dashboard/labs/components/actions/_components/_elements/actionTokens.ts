...
export const ACTION_TOKENS = {
  button: {
    ...
    siteNavigation: "action.button.site-navigation",
    siteNavigationAlt: "action.button.site-navigation-alt",
    siteNavigationGroup: "action.button.site-navigation-group",
    siteNavigationGroupAlt: "action.button.site-navigation-group-alt",
