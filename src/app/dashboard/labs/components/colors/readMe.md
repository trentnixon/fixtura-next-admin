...
- LLM guide: `/dashboard/labs/components/guide#colors`
- Use when: Semantic state and brand decisions; neutrals carry most surfaces.
...
- Showcase: `src/app/dashboard/labs/components/colors/_components/`
