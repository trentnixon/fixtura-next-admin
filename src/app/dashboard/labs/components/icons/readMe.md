...
- Route: `/dashboard/labs/components/icons`
- LLM guide: `/dashboard/labs/components/guide#category-selection`
- Use when: Buttons, nav items, status blocks — prefer `lucide-react`.
...
- Showcase: `src/app/dashboard/labs/components/icons/_components/`
